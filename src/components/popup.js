...
export class Popup extends AbstractComponent {
  constructor({title, poster, descriptions, genre, rating, year, controls, durationMin, director, country, comment, authorOfComment, writer, actor, ageRestriction}) {
    super();
    this._title = title;
    this._poster = poster;
  ...
  <form class="film-details__inner" action="" method="get">
    <div class="form-details__top-container">
      ...
      <section class="film-details__controls">
        ...
        <label for="watchlist" class="film-details__control-label film-details__control-label--watchlist ${this._controls.isInWatchList ? `film-details__control-input:checked + .film-details__control-label"` : ``}">Add to watchlist</label>

        <input type="checkbox" class="film-details__control-input visually-hidden" id="watched" name="watched">
        <label for="watched" class="film-details__control-label film-details__control-label--watched ${this._controls.isWatched ? `film-details__control-input:checked + .film-details__control-label"` : ``}">Already watched</label>

        <input type="checkbox" class="film-details__control-input visually-hidden" id="favorite" name="favorite">
        <label for="favorite" class="film-details__control-label film-details__control-label--favorite ${this._controls.isFavorite ? `film-details__control-input:checked + .film-details__control-label"` : ``}">Add to favorites</label>
      </section>
    </div>
